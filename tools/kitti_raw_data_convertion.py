...
kitti_path = "/root/Dataset/kitti"
dates = ['2011_09_26', '2011_09_28', '2011_09_29', '2011_10_03', '2011_09_30']
# dates = ['2011_09_26']

dest_kitti_root = "/root/Dataset/kitti/kitti_raw_dataset"
...
def calib_generation(lidar_calib_file, cam_calib_file, calib_path):
    ...
    P3, P2 = load_intrinsic(cam_calib_file)
    kitti_calib = dict()
...
if __name__ == "__main__":
    ...
    for date_id in dates:
        date_path = os.path.join(kitti_path, date_id)
        ...
        for scene_folder in os.listdir(date_path):
            ...
            for file_name in os.listdir(src_image_02_path):
                ...
                dest_file_name = "{:06d}".format(data_id)
                data_id = data_id + 1
                ...
                dest_image_02_file_name = os.path.join(dest_kitti_root, "image_2", dest_file_name + ".png")
                dest_image_03_file_name = os.path.join(dest_kitti_root, "image_3", dest_file_name +".png")
                dest_velodyne_file_name = os.path.join(dest_kitti_root, "velodyne", dest_file_name + ".bin")
                dest_calib_file_name = os.path.join(dest_kitti_root, "calib", dest_file_name + ".txt")
